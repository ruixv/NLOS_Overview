\begin{table*}[!t]
    ...
    \cite{heideDiffuseMirrors3D2014,kadambiOccludedImagingTimeofflight2016} & Modulated laser & ToF camera & Time of fight &  3D reconstruction\\%%%% Table body
...
Before these later dynamic systems, Nam~\etal~combined two gated $16\times1$ SPAD arrays (28 active pixels), sparse relay-wall scanning, virtual-aperture remapping, and fast Rayleigh--Sommerfeld phasor-field propagation to acquire and reconstruct diffuse, non-retroreflective hidden scenes at $5\,\mathrm{fps}$ with approximately $1\,\mathrm{s}$ latency~\cite{namRealTimeDynamicScenes2021}, providing an early full-pipeline real-time NLOS video milestone.
