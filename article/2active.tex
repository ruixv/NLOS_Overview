\begin{table*}[!t]
    ...
    \cite{chenSteadystateNonLineofSightImaging2019,vedaldi_imaging_2020,roueinfarNIRRaster2025} & Continuous laser & Conventional camera & Intensity &  3D reconstruction\\%%%% Table body
