...
**Update run: 17 July 2026.** This section tracks newly found or newly completed entries that were not explicitly covered in the previous README / homepage snapshot.
...
| 2025 | [Geometric Constrained Non-Line-of-Sight Imaging](https://arxiv.org/abs/2503.17992) — Liu et al. | arXiv 2025 | Jointly reconstructs volumetric albedo, depth, and hidden-surface geometry; a Frobenius-norm shape-operator prior regularizes surface-normal variation, improving sparse/short-exposure reconstruction while reporting roughly 30× lower optimization time than an existing surface-reconstruction baseline. |
