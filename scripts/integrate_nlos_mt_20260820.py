...
# README: latest entry, 2026 development trajectory, and update date.
path = Path("README.md")
text = read(path)
...
# Canonical V2 paper corpus / Paper Explorer / timeline.
...
# Homepage date badge only; V2 paper data stay canonical in data/papers-source.html.
...
# Survey prose: semantically place NLOS-MT between ST-Mamba and graph-NLOS branches.
...
# Canonical bibliography. Springer labels the proceedings volume with a 2027 citation year,
# while ICPR itself and first-online publication are in August 2026; preserve that metadata nuance.
...
# Provenance/update note retained after successful integration.
