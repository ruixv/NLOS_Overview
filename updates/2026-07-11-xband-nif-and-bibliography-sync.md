...
**Build result:** source synchronization and citation-key-normalized bibliography consolidation succeeded, but no strictly validated replacement PDF was committed. The prior PDF was preserved. Reason: PDF/reference validation failed (undefined=true, integrated=true, pdfinfo=0, pdftotext=0) (latexmk exit code 0). See `updates/2026-07-11-xband-nif-build-diagnostic.md`.
