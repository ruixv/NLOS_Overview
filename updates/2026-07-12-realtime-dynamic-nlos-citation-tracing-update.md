...
**Build result:** source synchronization completed, but the previous PDF was preserved. Reason: validation failed (undefined=false integrated=true pdf_text=false pdfinfo=0 pdftotext=0) (latexmk exit code 0). See the build diagnostic.
