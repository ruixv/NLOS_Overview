...
The synchronization workflow verifies the integrated ST-Mamba update and preserves its consistency across README, the website explorer/timeline, the active-system table, the survey narrative, bibliography, and rebuilt PDF.
...
This v2 branch is based on the latest master snapshot and triggers the reproducible pull-request synchronization and PDF rebuild.
