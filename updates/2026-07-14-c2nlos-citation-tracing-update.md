...
A same-repository pull-request validation run was staged so the Actions workflow can safely synchronize the text sources, merge the bibliography, and rebuild the binary PDF.
